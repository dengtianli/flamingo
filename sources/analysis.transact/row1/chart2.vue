...
<script>
  ...
  export default {
    ...
    mounted() {
      const vm = this;
      vm.acceptItems(vm.year, vm.organ)
    },
    watch: {
      year: function(year, oldVal) {
        console.log(year)
        this.acceptItems(year, this.organ)
      },
      organ: function(organ, oldVal) {
        console.log(organ)
        this.acceptItems(this.year, organ)
      }
    },
    methods: {
      ...
      acceptItems(year, organ) {
        const vm = this;
        Http.fetch({
          method: "get",
          url: master + "/analysis/projects/projects_accept",
          params: {
            year: year,
            organ: organ
          }
